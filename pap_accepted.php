...
$res=mysqli_query($connection,"select * from player1 WHERE status='accept'");
?>
...
<body>
<center><h1> ACCEPTED TEAMS </h1> </center>
<div class="container">
			<div class="row main">
				<div class="main-login main-center">
				
<table border="1">
<th>TEAM_ID</th><th>FORM_ID</th><th>NATIONALITY</th><th>ZONE</th> <th>DOCUMENT</th>  <th>DATE</th> <th>UPDATE</th> 
